...
This error may appear in different PHP versions `codes/selfInCallable <https://php-changed-behaviors.readthedocs.io/en/latest/behavior/codes/selfInCallable.html>`_.
