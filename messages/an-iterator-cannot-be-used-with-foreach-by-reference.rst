...
.. meta::
	:description:
		An iterator cannot be used with foreach by reference: It is possible to use a foreach loop with a reference on the blind variable: this allows the original data to be modified.
	:og:image: https://php-errors.readthedocs.io/en/latest/_static/logo.png
	:og:type: article
	:og:title: An iterator cannot be used with foreach by reference
	:og:description: It is possible to use a foreach loop with a reference on the blind variable: this allows the original data to be modified
