...
This error may appear following an evolution in behavior, in previous versions. See `dirWithNull <https://php-changed-behaviors.readthedocs.io/en/latest/behavior/dirWithNull.html>`_.
