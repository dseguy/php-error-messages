...
This error may appear following an evolution in behavior, in previous versions. See `e_strict.php <https://php-changed-behaviors.readthedocs.io/en/latest/behavior/e_strict.php.html>`_.
