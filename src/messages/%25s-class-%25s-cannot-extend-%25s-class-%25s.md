...
<script type="application/ld+json">{"@context":"https:\/\/schema.org","@graph":[{"@type":"WebPage","@id":"https:\/\/php-errors.readthedocs.io\/en\/latest\/messages\/%s-class-%s-cannot-extend-%s-class-%s.html","url":"https:\/\/php-errors.readthedocs.io\/en\/latest\/messages\/%s-class-%s-cannot-extend-%s-class-%s.html","name":"%s class %s cannot extend %s class %s","isPartOf":{"@id":"https:\/\/www.exakat.io\/"},"datePublished":"Tue, 04 Aug 2026 14:20:33 +0000","dateModified":"Tue, 04 Aug 2026 14:20:33 +0000","description":"This is the generic form of the error emitted when a ``readonly`` class and a non-``readonly`` class try to extend one another: the first two ``%s`` are ``Readonly``\/``Non-readonly`` plus the child class name, the last two are ``readonly``\/``non-readonly`` plus the parent class name","inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["https:\/\/php-errors.readthedocs.io\/en\/latest\/messages\/%s-class-%s-cannot-extend-%s-class-%s.html"]}]},{"@type":"WebSite","@id":"https:\/\/www.exakat.io\/","url":"https:\/\/www.exakat.io\/","name":"Exakat","description":"Smart PHP static analysis","inLanguage":"en-US"}]}</script>
